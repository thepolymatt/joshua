...
(library Library_1
	...
	(patternDef "EEE1AA221P" (originalName "EEE1AA221P")
		...
		(layerContents (layerNumRef 28)
			(line (pt -4.15 2) (pt -2.5 4.15) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.5 4.15) (pt 4.15 4.15) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 4.15 4.15) (pt 4.15 -4) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 4.15 -4) (pt 4.15 -4.15) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 4.15 -4.15) (pt -2.5 -4.15) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.5 -4.15) (pt -4.15 -2) (width 0.1))
		)
		(layerContents (layerNumRef 28)
	...
	(compDef "EEE-1CA101AP" (originalName "EEE-1CA101AP") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		...
		(attr "Datasheet Link" "http://industrial.panasonic.com/cdbs/www-data/pdf/RDE0000/ABA0000C1142.pdf")
		(attr "Height" "9.5 mm")
	)
