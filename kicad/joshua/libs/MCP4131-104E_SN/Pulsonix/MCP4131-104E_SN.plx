...
//244789/1381971/2.50/8/3/Variable Resistor
...
(library Library_1
	...
	(symbolDef "MCP4131-104E_SN" (originalName "MCP4131-104E_SN")
	...
	(compDef "MCP4131-104E_SN" (originalName "MCP4131-104E_SN") (compHeader (numPins 8) (numParts 1) (refDesPrefix VR)
		)
		...
		(compPin "3" (pinName "SDI/SDO") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "P0B") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "P0W") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "P0A") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MCP4131-104E_SN"))
		...
		(attr "Mouser Part Number" "579-MCP4131-104E/SN")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Microchip-Technology/MCP4131-104E-SN?qs=hH%252BOa0VZEiCC5jnuF305ZA%3D%3D")
		(attr "Manufacturer_Name" "Microchip")
		(attr "Manufacturer_Part_Number" "MCP4131-104E/SN")
		(attr "Description" "MCP4131-104E/SN, Digital Potentiometer 100k 129-Position Linear Serial-SPI 8-Pin SOIC")
		(attr "<Hyperlink>" "http://ww1.microchip.com/downloads/en/DeviceDoc/22060b.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "MCP4131-104E_SN.stp")
