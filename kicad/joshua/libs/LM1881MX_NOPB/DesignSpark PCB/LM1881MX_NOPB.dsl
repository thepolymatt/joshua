SamacSys ECAD Model
553448/1381971/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LM1881MX_NOPB" (originalName "LM1881MX_NOPB")
	...
	(compDef "LM1881MX_NOPB" (originalName "LM1881MX_NOPB") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "CSOUT") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "CVIN") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "VSOUT") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "7" (pinName "OEOUT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "RSET") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "BPOUT") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LM1881MX_NOPB"))
		...
		(attr "Arrow Part Number" "LM1881MX/NOPB")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/lm1881mxnopb/texas-instruments?utm_currency=USD&region=nac")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "LM1881MX/NOPB")
		(attr "Description" "Video Sync Separator")
		(attr "Datasheet Link" "https://www.arrow.com/en/products/lm1881mxnopb/texas-instruments?utm_currency=USD&region=nac")
		(attr "Height" "1.75 mm")
	)
