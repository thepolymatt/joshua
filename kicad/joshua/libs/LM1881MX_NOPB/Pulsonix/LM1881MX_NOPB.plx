...
(library Library_1
	...
	(compDef "LM1881MX_NOPB" (originalName "LM1881MX_NOPB") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "CSOUT") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "CVIN") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "VSOUT") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "OEOUT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "RSET") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "BPOUT") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.arrow.com/en/products/lm1881mxnopb/texas-instruments?utm_currency=USD&region=nac")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "LM1881MX_NOPB.stp")
