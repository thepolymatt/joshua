...
//364596/1381971/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LM386N-4_NOPB" (originalName "LM386N-4_NOPB")
	...
	(compDef "LM386N-4_NOPB" (originalName "LM386N-4_NOPB") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LM386N-4_NOPB"))
		...
		(attr "Mouser Part Number" "926-LM386N-4/NOPB")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/LM386N-4-NOPB?qs=QbsRYf82W3FsJPldcpZj5g%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "LM386N-4/NOPB")
		(attr "Description" "Audio power amplifier,LM386N-4 1W Texas Instruments LM386N-4/NOPB Audio Amplifier, Class-AB Mono, 8-Pin MDIP")
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/lm386.pdf")
		(attr "<Component Height>" "5.08")
		(attr "<STEP Filename>" "LM386N-4_NOPB.stp")
