...
(library Library_1
	...
	(patternDef "TSOP34438" (originalName "TSOP34438")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 2.322, -1.250) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -0.46 1.55) (pt 5.54 1.55) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 5.54 1.55) (pt 5.54 -4.05) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 5.54 -4.05) (pt -0.46 -4.05) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -0.46 -4.05) (pt -0.46 1.55) (width 0.025))
		)
	...
	(compDef "TSOP34438" (originalName "TSOP34438") (compHeader (numPins 3) (numParts 1) (refDesPrefix U)
		...
		(attr "<Hyperlink>" "https://www.vishay.com/docs/82489/tsop322.pdf")
		(attr "<Component Height>" "10.25")
		(attr "<STEP Filename>" "TSOP34438.stp")
		(attr "<STEP Offsets>" "X=2.52;Y=-0.23;Z=6.94")
